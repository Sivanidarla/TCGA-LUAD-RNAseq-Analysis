...
**Transcriptional Shift:** A large number of genes (9,657) met the adjusted significance threshold ($adj. P < 0.05$), indicating substantial differences between subtypes.

**Functional Interpretation:** Pathway enrichment analysis of genes upregulated in the PP subtype revealed strong enrichment for mitotic and chromosome segregation processes, indicating a proliferation-driven transcriptional program consistent with the known biology of this subtype.
